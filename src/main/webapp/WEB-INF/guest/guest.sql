...
create table guest (
	...
	hostIp varchar(30) not null                  /* 방문자의 접속 IP (not null안해도 상관없다.) */
);
desc guest;

insert into guest values (default, '관리자', '방명록 서비스를 시작합니다.' , 'himchan12345@naver.com', 'www.naver.com', default, '192.168.50.60');   /* 더미 데이터 */
select * from guest;