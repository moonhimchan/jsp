...
<head>
  ...
  <script src="test05Ok.jsphttps://cdn.jsdelivr.net/npm/jquery@3.7.1/dist/jquery.slim.min.js"></script>
...
<!-- <form name="myform" method="post" action="test05Ok.jsp">--> 
    ...
    <div>나이를 입력하시요
      <input type="number" name="age" value="25" class="form-control mb-2" required>
    </div>
    <div>
