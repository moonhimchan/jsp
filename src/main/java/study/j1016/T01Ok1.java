...
public class T01Ok1 extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 
		  if((mid.equals("admin") && pwd.equals("1234")) || (mid.equals("hkd1234") &&
		  pwd.equals("1234"))) { System.out.println("로그인 완료"); out.println("<script>");
		  out.println("alert('"+mid+"님 로그인 되셨습니다.');");
		  out.println("location.href='"+request.getContextPath()+
		 "/study/1016/t02_Member.jsp';"); out.println("</script>"); } else {
		  System.out.println("아이디틀림"); out.println("<script>");
		  out.println("alert('회원 정보를 확인하세요.');");
		  out.println("location.href='"+request.getContextPath()+
		 "/study/1016/t02_Dispatcher.jsp';"); out.println("</script>"); }
		 */
