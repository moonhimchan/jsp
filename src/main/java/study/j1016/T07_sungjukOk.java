...
public class T07_sungjukOk extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 처리된 결과를 VO객체에 담으려 한다.
		// 1. 생성자를 이용한 값의 주입(처리) 사용자 정의 생성자를 정의한다.
		// SungjukVO vo = new SungjukVO(name, hakbun, kor, eng, mat, soc, sci, tot, avg, grade, hostIp);
		
		// 2. setter를 통한 값의 주입(처리) 기본생성자를 이용한다.
    ...
    // request.setAttribute("mat", mat);
	  // request.setAttribute("soc", soc);
		...
		//String viewPage="/study/1016/t07_res.jsp"; // 목적지 주소
		String viewPage="/study/1016/t07_res2.jsp"; // 목적지 주소
