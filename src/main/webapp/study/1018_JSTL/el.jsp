...
%>		
	mbc = <%=mbc %><br/>
	kbs = <%=kbs %><br/>		<!-- http://localhost:9090/javaGroup/study/1018_JSTL/el.jsp?mbc=200&kbs=50  QueryString형식-->
	
	mbc = ${param.mbc}<br/>
	kbs = ${param.kbs}<br/>	
	mbc - kbs = ${param.mbc -  param.kbs}<br/> <!-- param.을 쓰면 값을 저장하지 않고 바로 쓸수 있다. get방식 -->
