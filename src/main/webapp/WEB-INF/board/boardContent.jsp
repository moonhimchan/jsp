						    ...
						    <table class="table table-borderless text-center">
						      <tr>
						        ...
						        <td style="width:15%"><br/>
						          <p>작성자 : ${sNickName}</p>
						          <p>
						            <a href="javaccript:replyUpdateCheck(${vo.idx})" onclick="replyUpdateCheck(${vo.idx})" class="badge badge-warning btn-sm">댓글수정</a>
						            <a href="javaccript:replyUpdateViewClose(${vo.idx})" onclick="replyUpdateViewClose(${vo.idx})" class="badge badge-warning btn-sm">창닫기</a>
						          </p>
						        </td>
						      </tr>
						    </table>
